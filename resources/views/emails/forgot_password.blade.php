						...
						<div style="text-align: center;background-color: #f7f7f7;padding: 50px;margin-bottom: 20px;">
						   ...
						   <table style="margin-left: 85px;width: 65%; border-bottom: 1px solid #d2dbe5">
							<tbody>
								...
								<tr>
									<td>
										<p style="color: #2f4058;font-size: 20px;margin-top: 0px;margin-bottom: 10px;font-family: 'Roboto', sans-serif;font-weight: 400;">Reset your password</p>
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td>
										<p style="color: #2f4058;font-size: 15px;margin-bottom: 5px;font-family: 'Roboto', sans-serif;font-weight: 400;width: 95%;">You’re almost ready to get started. Please click the link below to reset your password</p>
									</td>
								</tr>
								<tr>
									<td>
										<h3 style="color: #2f4058;font-size: 15px;margin-bottom: 5px;font-family: 'Roboto', sans-serif;font-weight: 400;width: 95%;">{{ $code }}</h3>
									</td>
								</tr>
								{{-- <tr>
									<td>
