                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input   type="text" class="form-control" value="{{ $data->user_name }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input   type="text" class="form-control" value="{{ $data->country }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="custom-select mr-0 font-weight-500" name="status_id"
                                            id="status_id">
