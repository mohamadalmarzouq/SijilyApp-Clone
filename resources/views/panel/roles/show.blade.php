The content may not be greater than 200 characters.@extends('panel.master')
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="card card-body">
                    <div class="search-form mg-t-20 mg-sm-t-0 w-50 mr-3">
                        <input type="text" id="search" class="form-control" placeholder="Search Role">
