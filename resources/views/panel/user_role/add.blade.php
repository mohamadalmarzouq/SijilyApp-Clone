            ...
            <div class="col-sm-12 col-lg-12">
                <div class="card card-body">
                    <div>
                        ...
                        <form method="POST" action="{{ route($module.'.add') }}" id="addForm" data-module="user_roles">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name_ar" type="text" required class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    @foreach($module_permissions as $key => $module)
                                       <div class="col-sm-12">
                                            <label for="access_modules_{{ $key }}" class="checkbox_container user_roles_label">
                                                <input type="checkbox" class="access_modules" id="access_modules_{{ $key }}" name="access_modules[]" value="{{ $module['id'] }}"/>
                                                {{ $module['name'] }}
