                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="full_name" disabled type="text" required class="form-control" value="{{ $data->full_name }}">
                                        <input name="is_child" disabled type="hidden" class="form-control" value="{{ $data->is_child }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                 ...
                                 @if($data->is_child)
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="role_id" class="form-control" style="pointer-events:none">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="user_name" type="text" disabled class="form-control" value="{{ $data->user_name }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="mb-1">Contact</label>
                                        <input name="contact"  type="text" disabled class="form-control" value="{{ $data->contact }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="mb-1">Business Name</label>
                                        <input required  type="text"  disabled class="form-control" name="business_name"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="address"  type="text" disabled class="form-control" value="{{ $data->address }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input  maxlength="10" type="text" disabled class="form-control" name="postal_code"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input  name="city"  type="text" disabled class="form-control" value="{{ $data->city }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" style="pointer-events:none" name="country" disabled>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="mb-1">Company Year End Date</label>
                                         <select class="form-control" style="pointer-events:none" name="company_year_end_date">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" style="pointer-events:none" name="language">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="custom-select mr-0 font-weight-500" style="pointer-events:none" name="status_id"
                                            id="status_id">
