            ...
            <div class="col-sm-12 col-lg-12">
                <div class="card card-body">
                    <div class="d-flex justify-content-between align-items-end mb-3">
                        <h3 class="tx-18">New Subscription</h3>
                    ...
                    <table id="new_subscriptions" class="datatable"
                        data-route="{{ route($module . '.new_subscrption_ajax') }}">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Name</th>
        ...
        $(function() {
            ...
            var dataTable_fns = {
                ...
                callDataTable(filter, changed) {
                    var route = $("#new_subscriptions").attr("data-route");
                    var columns = [{
                            data: 'id'
                            , orderable: true 
                        },
                    ...
                    var table = $("#new_subscriptions").DataTable({
                        dom: 'Bfrtip',
                        buttons: [{
                                extend: 'excel',
           ...
           columnDefs: [],  
                    ...
                    $("#new_subscriptions").css("width", "100%");
