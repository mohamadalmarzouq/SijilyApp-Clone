            ...
            <div class="col-sm-12 col-lg-12">
                <div class="card card-body">
                   <div class="d-flex justify-content-between align-items-end mb-3">
                        <h3 class="tx-18">Subscription Sold</h3>
                    ...
                    <table id="subscription_sold" class="datatable" data-route="{{ route($module.'.subscriptions_sold_ajax') }}">
                        <thead>
                            <tr>
                                <th>id</th>
                                <th>Subscription</th>
        ...
        $(function() {
            ...
            var dataTable_fns = {
                ...
                callDataTable(filter,changed) {
                        var route = $("#subscription_sold").attr("data-route");
                        var columns = [
                                    {
                                        data: 'id'
                                    },
                        ...
                        var table = $("#subscription_sold").DataTable({
                            dom: 'Bfrtip',
                            buttons: [
                                {
                                    extend:'excel',
                        ...
                        $("#subscription_sold").css("width", "100%");
