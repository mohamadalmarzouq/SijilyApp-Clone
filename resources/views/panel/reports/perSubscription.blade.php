            ...
            <div class="col-sm-12 col-lg-12">
                <div class="card card-body">
                     <div class="d-flex justify-content-between align-items-end mb-3">
                        <h3 class="tx-18">Per Subscription</h3>
                    ...
                    <table id="per_subscription" class="datatable" data-route="{{ route($module.'.per_subscription_ajax') }}">
                        <thead>
                            <tr>
                                <th>Id</th>
        ...
        $(function() {
            ...
            var dataTable_fns = {
                ...
                callDataTable(filter,changed) {
                        var route = $("#per_subscription").attr("data-route");
                        var columns = [{
                                        data: 'id'
                                    },
                                    {
                        ...
                        var table = $("#per_subscription").DataTable({
                            dom: 'Bfrtip',
                            buttons: [
                                {
                                    extend:'excel',
                        ...
                        $("#per_subscription").css("width", "100%");
