            ...
            <div class="col-sm-12 col-lg-12">
                <div class="card card-body">
                    <div>
                        ...
                        <form method="POST" action="{{  route($module.'.edit',['id' => $id]) }}" id="editForm">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="mb-1">Name <span class="color_red">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="email" readonly type="text" class="form-control" value="{{ $data->email }}">
                                    </div>
                                </div>
